function Whyjonus(){
    return(
        <div className="w-full">
            <div className="flex pt-5 font-bold flex-col items-center gap-16 container text-white mx-auto">
                ...
                <div className="flex flex-wrap justify-center">
                    ...
                    <div className="w-[400px] flex flex-col p-16 gap-5 hover:bg-[#120f4e]  rounded-xl">
                        <h1 className="text-4xl">New People</h1>
                        <p className="text-xl">How you transform your business as technology, consumer, habits industry dynamic</p>
                    </div>
                    <div className="w-[400px] flex flex-col p-16 gap-5 hover:bg-[#120f4e]  rounded-xl">
